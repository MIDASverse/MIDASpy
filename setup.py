...
install_requires = ['numpy>=1.5', 'scikit-learn', 'matplotlib', 'pandas>=0.19', 'tensorflow_addons>=0.11', 'statsmodels', 'scipy']
...
setup(
    ...
    download_url='https://github.com/MIDASverse/MIDASpy/archive/v1.2.4.tar.gz',
