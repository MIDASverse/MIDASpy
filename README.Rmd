...
For a R package implementation, see our **rMIDAS** repository [here](https://github.com/MIDASverse/rMIDAS).
...
* Numpy (>=1.5)
* Pandas (>=0.19)
* Tensorflow (>= 1.10) -- **NOTE**: 2.X is not yet supported for performing imputations
* Matplotlib
